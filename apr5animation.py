...
class Particle(object):
    ...
    def __init__(self, x0=0.0, y0=0.0, z0=0.0, u0=0.0, v0=0.0, w0=0.0, tf=10.0, dt=0.01):
...
class SoccerBall(Particle):
    ...
    def __init__(self, m=0.45, r=10.5e-2, x0=0.0, y0=0.0, z0=0.0, u0=0.0, v0=0.0, w0=0.0, tf=10.0, dt=0.001):
    ...
    def Cd(self, Re):
        if Re <= 1:
            ...
            Drag_Coeff = -7 / 1500000 * Re + 257 / 150  # sharp linear decrease over this region (drag crisis)
        else:
